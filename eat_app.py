...
if st.button('See example'):
    ...
    timestamps in the uploaded file. Trend data columns should have meaningful titles. For best practice, use *lowercase*, *lowercase_with_underscores*, or *camelCase*)
